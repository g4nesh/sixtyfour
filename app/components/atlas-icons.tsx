...
export function GraphIcon(props: IconProps) {
  return <IconBase {...props}><circle cx="5" cy="12" r="2" /><circle cx="18" cy="5" r="2" /><circle cx="19" cy="18" r="2" /><path d="m7 11 9-5M7 13l10 4M18 7l1 9" /></IconBase>;
}

export function ListIcon(props: IconProps) {
  return <IconBase {...props}><path d="M9 6h11M9 12h11M9 18h11" /><circle cx="4" cy="6" r="1" fill="currentColor" stroke="none" /><circle cx="4" cy="12" r="1" fill="currentColor" stroke="none" /><circle cx="4" cy="18" r="1" fill="currentColor" stroke="none" /></IconBase>;
}

export function FitIcon(props: IconProps) {
  return <IconBase {...props}><path d="M4 9V4h5M15 4h5v5M20 15v5h-5M9 20H4v-5" /></IconBase>;
}
...
export function ArrowIcon(props: IconProps) {
  return <IconBase {...props}><path d="M4 12h16m-5-5 5 5-5 5" /></IconBase>;
}
